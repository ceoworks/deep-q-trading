...
dqt = DeepQTrading(
    ...
    trainSize=datetime.timedelta(days=1100),
    validationSize=datetime.timedelta(days=110),
    testSize=datetime.timedelta(days=110),
    outputFile="./Output/csv/walks/walks-btcEnsemble3",
